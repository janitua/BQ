...
def create_table(dataset_name, table_name, project):
    ...
    table.schema = (
        ...
        bigquery.SchemaField('Criterion_ID','STRING'),
        bigquery.SchemaField('Audience','STRING'),
        bigquery.SchemaField('Audience_State','STRING'),
        bigquery.SchemaField('Device','STRING'),
        bigquery.SchemaField('Bid_Adj','STRING'),
...
if __name__ == '__main__':
    ...
    for region in regions:
		...
		source='gs://rlsa/'+region+'/list_'+region+'.csv'
