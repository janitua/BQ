...
_FILE_SUFFIX = "AUDIENCE_PERFORMANCE_REPORT.csv"
...
_REPORT_AWQL = ('SELECT Week, AccountDescriptiveName, CampaignName, CampaignId, CampaignStatus, AdGroupName, AdGroupId ,AdGroupStatus,'
                'Id, Criteria, Status, Device, BidModifier, BidModifier, Impressions, Cost, Conversions, ConvertedClicks,'
...
def download_report(client,client_customer_id,client_folder):
  ...
  file_path = str('C:/Users/janitua/Documents/PYTHON/BQ DATA/RLSA_report')  + '/' + str('lists/') +str(client_folder) + "/"+ str(client_customer_id) + _FILE_SUFFIX
